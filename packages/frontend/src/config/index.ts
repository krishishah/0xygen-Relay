...
export const RELAYER_HOST = 'http://localhost:3000';

export const RELAYER_ZERO_EX_WS_URL = 'ws://localhost:3001';
export const RELAYER_OFF_CHAIN_WS_URL = 'ws://localhost:3002';

export const PAYMENT_NETWORK_HTTP_URL = 'http://localhost:3003';
export const PAYMENT_NETWORK_WS_URL = 'ws://localhost:3004';